...
* 
* Generated at 09/30/2024 15:22:16 UTC. Any changes will be lost.
* 
...
// Working memory
static int8_t _state[592];

// Memory mapped buffers
#define _K5              ((int8_t *)(_state + 0x00000000))   // s8[592] (592 bytes) 
...
int IMAI_dequeue(float *restrict data_out, float *restrict time_out) {    
    __RETURN_ERROR(fixwin_dequeuef32(_K5, data_out, 5, time_out));
    return 0;
}
