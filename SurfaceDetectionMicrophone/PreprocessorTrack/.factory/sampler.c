/*
* DEEPCRAFT Studio 5.5.3240.65534+05daa4ef093ffe43eeee1fd4d6051a8bfe51c5c0
* Copyright © 2023- Imagimob AB, All Rights Reserved.
* 
* Generated at 07/01/2025 11:08:46 UTC. Any changes will be lost.
* 
* Memory    Size                      Efficiency
* Buffers   6152 bytes (RAM)          100 %
* State     7480 bytes (RAM)          100 %
* Readonly  2256 bytes (Flash)        100 %
* 
...
*    Parameter data_out is Output of size float[50].
...
static const uint32_t _K15[] = {
    0x00000009, 0x0000000b, 0x0000000c, 0x0000000d, 0x0000000f, 0x00000011, 0x00000012, 0x00000014, 
    0x00000016, 0x00000018, 0x0000001a, 0x0000001c, 0x0000001e, 0x00000021, 0x00000023, 0x00000026, 
    0x00000028, 0x0000002b, 0x0000002e, 0x00000031, 0x00000034, 0x00000037, 0x0000003b, 0x0000003e, 
    0x00000042, 0x00000046, 0x0000004a, 0x0000004e, 0x00000052, 0x00000057, 0x0000005c, 0x00000060, 
    0x00000066, 0x0000006b, 0x00000071, 0x00000077, 0x0000007d, 0x00000083, 0x0000008a, 0x00000091, 
    0x00000098, 0x000000a0, 0x000000a7, 0x000000b0, 0x000000b8, 0x000000c1, 0x000000cb, 0x000000d4, 
    0x000000df, 0x000000e9, 0x000000f4, 0x00000100
};

// Memory mapped buffers
#define _K15             ((int *)_K15)                       // s32[52] (208 bytes) 
#define _K8              ((float *)_K8)                      // f32[512] (2048 bytes) 
#define _K11             ((int *)(_state + 0x000018d0))      // s32[24] (96 bytes) 
#define _K12             ((float *)(_state + 0x00001930))    // f32[258] (1032 bytes) 
#define _K7              ((int8_t *)(_state + 0x00000000))   // s8[6352] (6352 bytes) 
#define _K10             ((float *)(_buffer + 0x00001000))   // f32[257,2] (2056 bytes) 
#define _K13             ((float *)(_buffer + 0x00000000))   // f32[512] (2048 bytes) 
#define _K14             ((float *)(_buffer + 0x00000000))   // f32[257] (1028 bytes) 
#define _K16             ((float *)(_buffer + 0x00000404))   // f32[50] (200 bytes) 
#define _K17             ((float *)(_buffer + 0x00000000))   // f32[50] (200 bytes) 
#define _K18             ((float *)(_buffer + 0x000000c8))   // f32[50] (200 bytes) 
#define _K5              ((float *)(_buffer + 0x00000000))   // f32[512] (2048 bytes) 
#define _K9              ((float *)(_buffer + 0x00000800))   // f32[512] (2048 bytes) 
...
int IMAI_dequeue(float *restrict data_out, float *restrict time_out) {    
    __RETURN_ERROR(fixwin_dequeuef32(_K7, _K5, 160, time_out));
    hammingmul_f32(_K5, _K8, _K9, 512, 1);
    rdft_ndim_f32(_K9, _K10, 1, 512, 1, _K11, _K12, _K13);
    norm_f32(_K10, 1, 2, 257, _K14);
    mel_f32(_K14, _K15, 257, 1, 50, _K16);
    addi_f32(_K16, 50, 1, _K17);
    loge_f32(_K17, 50, _K18);
    clip_f32(_K18, 50, 0, 4, data_out);
    return 0;
}
