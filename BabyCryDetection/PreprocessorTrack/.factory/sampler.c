/*
* DEEPCRAFT Studio 5.3.2104.65534+a0d417755748e65fded4b1ec8999590579f6d0e1
* Copyright © 2023- Imagimob AB, All Rights Reserved.
* 
* Generated at 11/15/2024 12:20:05 PM UTC. Any changes will be lost.
* 
...
*    Parameter data_out is Output of size float[20].
...
#define _K13             ((int *)_K13)                       // s32[22] (88 bytes) 
...
#define _K14             ((float *)(_buffer + 0x00000404))   // f32[20] (80 bytes) 
#define _K15             ((float *)(_buffer + 0x00000000))   // f32[20] (80 bytes) 
...
int IMAI_dequeue(float *restrict data_out, float *restrict time_out) {    
    ...
    mel_f32(_K12, _K13, 257, 1, 20, _K14);
    clip_f32(_K14, 20, 0.000316227766016, 3.40282347E+38, _K15);
    loge_f32(_K15, 20, data_out);
    return 0;
}
